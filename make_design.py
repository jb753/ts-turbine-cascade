...
phi = 0.4  # Flow coefficient (0.4 to 1.2)
psi = 2.6  # Stage loading coefficient (0.8 to 2.4)
Lam = 0.3  # Degree of reaction (0.4 to 0.6)
Ma = 0.8  # Vane exit Mach number (0.6 to 0.9)
